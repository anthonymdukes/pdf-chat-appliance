...
class ChatHistoryDB:
    ...
    def get_history(self, user_id: str, document_id: str, limit: int = 10) -> List[ChatMessage]:
        with self.Session() as db:
            q = db.query(ChatMessage).filter_by(user_id=user_id, document_id=document_id)
